...
export const ServicesSection: React.FC = () => {
  ...
  const serviceCards = [
    {
      ...
      image: "/assets/images/cab-range(1).png",
      icon: (
      ...
      {
      title: "Trusted1 & Budget-Friendly",
      ...
      image: "/assets/images/trusted-cab(1).png",
      icon: (
    ...
    },
    {
      ...
      image: "/assets/images/popular-routes(1).png",
      icon: (
  ...
  return (
    <section ref={ref} id="services" className="relative w-full pt-6 md:pb-16 pb-8 -mt-8 bg-white">
