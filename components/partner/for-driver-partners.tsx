...
export const ForDriverPartners = () => {
  return (
    <>
      ...
      <section className="w-full flex justify-center items-center mt-5 lg:mt-10 md:py-0 lg:pt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center"> */}
          <div className="flex flex-wrap gap-5 lg:gap-8 items-center justify-center">
            ...
            >
              ...
              <motion.div
                variants={containerVariants}
                className="flex flex-col md:flex-row items-center gap-8 w-full mb-12 h-fit"
              >
                {keyPoints.map((point, index) => (
                  <motion.div
                    key={index}
