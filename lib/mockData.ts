...
export const MOCK_FEATURED_STORIES: Blog[] = [
  ...
  },
  {
    ...
    title: 'The Future of Road Travel in India | Luxury Heritage Hotels | Udaipur',
    excerpt: '',
...
export const MOCK_BLOGS: Blog[] = [
  {
    ...
    excerpt: 'Discover the hidden valleys, quaint local cafes, and snow-filled pine forests that make Manali a true adventure haven. Plan your trip with AAVORide.',  // category: 'Hill Stations Tour',
    tag: 'ADVENTURE',
  ...
  },
  {
    ...
    excerpt: "Explore how luxury caravans, highway corridors, and app-based cab rentals are revolutionizing India's travel experience — only with AAVORide.", // category: 'Cab Rental Tips',
    tag: 'LUXURY',
